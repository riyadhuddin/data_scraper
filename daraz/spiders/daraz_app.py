...
class DarazAppSpider(scrapy.Spider):
    name = 'daraz_app'
    allowed_domains = ['https://www.daraz.com.bd']
    start_urls = ['http://https://www.daraz.com.bd/womens-sarees//']
    custom_settings={ 'FEED_URI': "daraz_%(time)s.csv",
                       'FEED_FORMAT': 'csv'}
